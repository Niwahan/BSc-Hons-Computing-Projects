public class AcademicCourse extends Course
{
    ...
    public AcademicCourse(String CourseID, String CourseName, int CourseDuration, String Level, int Credit, int NumberOfAssessments)
    {
        /*
    ...
    public void Display()
    {
         ...
         * Conditional is used to check if a course is registered.
         */ 
        super.Display();
        if(isRegistered == true)
        {
